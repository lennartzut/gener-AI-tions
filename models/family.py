...
class Family(db.Model):
    ...
    partner1_id = db.Column(db.Integer, db.ForeignKey('individuals.id'), nullable=False)
    partner2_id = db.Column(db.Integer, db.ForeignKey('individuals.id'), nullable=False)
    ...
    partner1 = db.relationship(
        ...
        overlaps="families_as_partner1, partner1_family"
    )
    partner2 = db.relationship(
        'Individual',
        foreign_keys=[partner2_id],
        overlaps="families_as_partner2, partner2_family"
    )
